#############################################################################
# Makefile for building: modbus_client2
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  modbus_client.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile modbus_client.pro
#############################################################################
...
INCPATH       = -I. -I/opt/pvb/rllib/lib -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = modbus_client21.0.0
DISTDIR = /home/prointegra/repositorios/desarrollo/modbus_client2/.tmp/modbus_client21.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -lpthread /usr/lib/librllib.so 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = modbus_client2.cpp 
OBJECTS       = modbus_client2.o
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		modbus_client.pro  modbus_client2.cpp
QMAKE_TARGET  = modbus_client2
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = modbus_client2
...
Makefile: modbus_client.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		modbus_client.pro
	$(QMAKE) -o Makefile modbus_client.pro
...
modbus_client2.o: modbus_client2.cpp /opt/pvb/rllib/lib/rlmodbus.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modbus_client2.o modbus_client2.cpp
